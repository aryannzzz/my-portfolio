...
(function() {
  ...
  // Icon SVGs for light and dark modes
  ...
  class DarkModeManager {
    ...
    setup() {
      this.toggleButton = document.querySelector('.mode-toggle');
    ...
    updateIcon() {
      ...
      this.toggleButton.innerHTML = this.isDarkMode ? DARK_MODE_ICON : LIGHT_MODE_ICON;
    ...
    updateMetaThemeColor() {
      ...
      metaThemeColor.content = this.isDarkMode ? '#1e293b' : '#ffffff';
    }

    savePreference() {
      localStorage.setItem(STORAGE_KEY, this.isDarkMode.toString());
    }
